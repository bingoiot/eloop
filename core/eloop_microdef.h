...
#ifndef _ELOOP_MICRODEF_H_
#define _ELOOP_MICRODEF_H_

#include "eloop_config.h"

#if	(ELOOP_ENABLE_MICRO_DEFINE)
...
typedef void 	(*eloop_timer_cb_t)(u_int8 sig);
typedef void 	(*eloop_task_t)(u_int32 evt, void *arg, u_int32 len);
typedef u_int8	(*eloop_power_conserve_t)(u_int32 tim);
